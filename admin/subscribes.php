...
<?php require_once("./top_navigation.php") ?>
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2 style="font-weight: bold">Subscribes</h2>
        </div>
    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover " id="editable">
                            ...
                            <?php
                                ...
                                foreach($infos as $row){
                                    ...
                                    echo '<td>
                                            <a href="./action.php?key=delSubscribe&sid='. $id . '" class="btn" rel="tooltip" title="Delete"><i class="fa fa-trash-o"></i></a>
                                          </td>';
                                    echo '</tr>';
                                    $index ++;
                                }
